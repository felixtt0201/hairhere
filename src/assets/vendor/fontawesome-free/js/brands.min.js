...
!(function () {
  let c = {}; let l = {}; try { typeof window !== 'undefined' && (c = window), typeof document !== 'undefined' && (l = document); } catch (c) {} const z = (c.navigator || {}).userAgent; const h = void 0 === z ? '' : z; const m = c; const v = l; const a = (m.document, !!v.documentElement && !!v.head && typeof v.addEventListener === 'function' && v.createElement, ~h.indexOf('MSIE') || h.indexOf('Trident/'), '___FONT_AWESOME___'); const M = (function () { try { return !0; } catch (c) { return !1; } }()); const s = m || {}; s[a] || (s[a] = {}), s[a].styles || (s[a].styles = {}), s[a].hooks || (s[a].hooks = {}), s[a].shims || (s[a].shims = []); const H = s[a]; function V(c, h) {
    ...
    }({}, H.styles[c] || {}, m)) : H.hooks.addPack(c, m), c === 'fas' && V('fa', h);
  } const e = {
  ...
  }; !(function (c) { try { c(); } catch (c) { if (!M) throw c; } }(() => { V('fab', e); }));
}());
